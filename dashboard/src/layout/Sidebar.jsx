  ...
  return (
    <div>
      <div
        ...
        } w-screen h-screen top-0 left-0 z-10 border bg-red-500`}
      ></div>
      <div
        className={`w-[260px] fixed bg-[#283046] z-50 top-0 left-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${
